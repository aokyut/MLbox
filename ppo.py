...
class ppo_brain:
    ...
    def update_parameter(self):
        ...
        # print("::::::::",feed_dict,"::::::::")
        # print(SESS.run([self.policy_loss,self.value_loss,self.entropy], feed_dict))
...
class ppo_agent:
    ...
    def greedy_action(self,state):
        if frame >= EPS_STEPS:   # ε-greedy法で行動を決定します 171115修正
            eps = EPS_END
        else:
            eps = EPS_START + frame* (EPS_END - EPS_START) / EPS_STEPS  # linearly interpolate
